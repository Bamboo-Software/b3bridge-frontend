...
const ConfirmCreateToken = ({ next }: ConfirmCreateTokenProps) => {
                ...
                <CollapsibleContent className="space-y-3 mt-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">
                      Total fees: <span className="text-[#34D3FF]">2000 ETH</span>
                    </span>
                    <div className="bg-[#003721] text-[#41D483] px-3 py-1 rounded-lg text-sm flex items-center gap-1 border-[#41D483]">
            ...
            <Collapsible open={openChains.avalanche} onOpenChange={() => toggleChain("avalanche")}>
              <div className="bg-[#1a1d21] rounded-lg p-4">
                ...
                <CollapsibleContent className="space-y-3 mt-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">
                      Total fees: <span className="text-[#34D3FF]">2000 AVAX</span>
                    </span>
                    <Button className="bg-[linear-gradient(45deg,_var(--blue-primary),_var(--primary))]
        shadow-[0_0px_10px_0_var(--blue-primary)]
        border-none
        rounded-lg
        cursor-pointer
        hover:opacity-90
        hover:shadow-[0_0px_16px_0_var(--blue-primary)] text-foreground  px-6 py-1 h-8 text-sm">Pay</Button>
                  </div>
                </CollapsibleContent>
              </div>
            </Collapsible>
            ...
            <Collapsible open={openChains.bsc} onOpenChange={() => toggleChain("bsc")}>
              <div className="bg-[#1a1d21] rounded-lg p-4">
                ...
                <CollapsibleContent className="space-y-3 mt-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">
                      Total fees: <span className="text-[#34D3FF]">2000 BSC</span>
                    </span>
                     <Button className="bg-[linear-gradient(45deg,_var(--blue-primary),_var(--primary))]
        shadow-[0_0px_10px_0_var(--blue-primary)]
        border-none
