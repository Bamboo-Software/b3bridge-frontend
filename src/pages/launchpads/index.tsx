...
// Sub-tab trong "My Contributions"
// const SubTabs: React.FC<{
//   subTab: 'launchpads' | 'contributions';
//   setSubTab: (tab: 'launchpads' | 'contributions') => void;
// }> = ({ subTab, setSubTab }) => {
//   return (
//     <div className="mb-6 flex border-b border-[color:var(--gray-charcoal)]">
//       <button
//         onClick={() => setSubTab('launchpads')}
...
export default function LaunchpadsPage() {
  ...
  const [subTab, setSubTab] = useState<'launchpads' | 'contributions'>('contributions');
  ...
  const { useGetPreSalesExploreQuery } = preSaleApi;
        ...
        <Tabs value={subTab} onValueChange={(value) => setSubTab(value as 'contributions' | 'launchpads')}>
          ...
          <TabsContent value="contributions">
            <div className='py-12 text-center text-muted-foreground'>
              <p className='text-lg mb-2'>Coming soon: My Contributions</p>
              <p className='text-sm'>
                You’ll be able to view presales you’ve participated in.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="launchpads">
            <div className='py-12 text-center text-muted-foreground'>
              <p className='text-lg mb-2'>Coming soon: My Launchpads</p>
              <p className='text-sm'>
                You’ll be able to manage presales you’ve created.
              </p>
            </div>
          </TabsContent>
        </Tabs>
