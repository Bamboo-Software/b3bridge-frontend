...
export default function LaunchpadsPage() {
  ...
  const limit = 9;
  const [subTab, setSubTab] = useState<'launchpads' | 'contributions'>(
    'launchpads'
  );
    ...
    <div className='container mx-auto px-6 py-8'>
      ...
      {activeTab === 'all' && (
        <>
          ...
          {!isChainsLoading &&
            !isPresalesExploreLoading &&
            presalesExploreData.length === 0 && (
          ...
          <>
            <div>
              <Tabs
                value={subTab}
                onValueChange={(value) =>
                  setSubTab(value as 'contributions' | 'launchpads')
                }
              >
                <TabsList>
                ...
                <TabsContent value='contributions'>
                  <>
                    ...
                    {presalesContributionError &&
                      !isPresalesContributionLoading && (
                        <div className='text-center py-8 mb-8'>
                          <div className='text-yellow-500 text-sm mb-2'>
                            Failed to load latest data
                          </div>
                    ...
                    {!isChainsLoading &&
                      !isPresalesContributionLoading &&
                      presalesContributionData.length === 0 && (
                        <div className='text-center py-12'>
                          <div className='text-muted-foreground text-lg mb-2'>
                            No presales found
                          </div>
