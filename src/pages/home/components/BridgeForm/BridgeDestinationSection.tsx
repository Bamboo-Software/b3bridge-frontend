...
function BridgeDestinationSection({
  ...
  return (
    <div className='rounded-2xl border border-primary/20 bg-primary/5 p-4 shadow-sm space-y-5'>
      <div className='flex items-center justify-between gap-2 mb-2 rounded-xl bg-muted/30' style={{ minHeight: 40 }}>
        <div className='flex items-center gap-2 text-xs text-muted-foreground'>
          {isConnected ? (
            ...
            >
              {useCustomAddress ? 'Custom Wallet' : shortenAddress(watchedFromWallet || '')}
            </Button>
          ) : useCustomAddress ? (
            <Button
              type="button"
        ...
        <div className='flex items-center gap-2'>
          ...
          <Switch checked={useCustomAddress} onCheckedChange={setUseCustomAddress} />
        </div>
      </div>
      <FormField
                ...
                <div className='relative flex items-center'>
                  <Input
                    ...
                    className={cn(
                      ...
                      receiverValid === false && 'border-destructive focus-visible:ring-destructive/40'
                    )}
                    onBlur={(e) => {
