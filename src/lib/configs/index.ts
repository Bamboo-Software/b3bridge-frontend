...
export const ethereumEthAddress = import.meta.env.VITE_ETHEREUM_ETH_ADDRESS || '0x0000000000000000000000000000000000000001';
export const ethereumUsdcAddress = import.meta.env.VITE_ETHEREUM_USDC_ADDRESS || '0x0000000000000000000000000000000000000002';
...
export const seiEthAddress = import.meta.env.VITE_SEI_ETH_ADDRESS || '0x0000000000000000000000000000000000000003';
export const seiUsdcAddress = import.meta.env.VITE_SEI_USDC_ADDRESS || '0x0000000000000000000000000000000000000004';
